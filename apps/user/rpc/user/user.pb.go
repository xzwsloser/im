...
type UserEntity struct {
	...
	Nickname      string                 `protobuf:"bytes,3,opt,name=nickname,proto3" json:"nickname,omitempty"` // the nickname of user
	Phone         string                 `protobuf:"bytes,4,opt,name=phone,proto3" json:"phone,omitempty"`       // user phone number of user
	Status        int32                  `protobuf:"varint,5,opt,name=status,proto3" json:"status,omitempty"`    // if locked of not
	Sex           int32                  `protobuf:"varint,6,opt,name=sex,proto3" json:"sex,omitempty"`          // the gender of user
...
func (x *RegisterResp) GetExpire() string {
	if x != nil {
		return x.Expire
	}
	return ""
...
type FindUserReq struct {
	...
	Ids           []string               `protobuf:"bytes,3,rep,name=ids,proto3" json:"ids,omitempty"` // the arr of id
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
